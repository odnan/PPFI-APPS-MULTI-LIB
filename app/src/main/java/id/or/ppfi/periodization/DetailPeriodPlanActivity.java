...
/**
 * Copy by emergency on 25/09/2017.
 */

public class DetailPeriodPlanActivity extends AppCompatActivity {
    private ProgressDialog pDialog;
    private ProgressBar progressBar;
    Toolbar toolbar;
    String planedtype,url_image,title,notes,groupname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        planedtype = data.getStringExtra("planedtype");
        url_image = data.getStringExtra("url_image");
        ...
        getSupportActionBar().setTitle(planedtype);
        ...
        webview.setWebViewClient(new WebViewClient() {
            ...
            public void onLoadResource (WebView view, String url) {
                ...
                if (progressDialog == null && url.contains("androidexample")
                    ...
                    progressDialog = new ProgressDialog(DetailPeriodPlanActivity.this);
