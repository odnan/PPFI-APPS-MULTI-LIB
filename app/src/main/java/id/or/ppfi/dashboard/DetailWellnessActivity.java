...
public class DetailWellnessActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_5:
                ...
                urlModule = "http://mealplan.iamprima.com";
        ...
        webview.setWebViewClient(new WebViewClient() {
            ...
            public void onLoadResource (WebView view, String url) {
                ...
                if (progressDialog == null && url.contains("androidexample")
                    ...
                    progressDialog = new ProgressDialog(DetailWellnessActivity.this);
